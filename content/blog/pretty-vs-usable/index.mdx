...
lead: Good looking UIs receive a perceived usability bump. However, that doesn't mean we should be sacrificing usability in order to make the design as pretty as possible.
date: '2020-08-01'
---
...
The [beauty premium phenomenon](https://en.wikipedia.org/wiki/Physical_attractiveness_stereotype#Beauty_premium_phenomenon) states that we expect that good-looking people are "better, smarter, more successful, more important, and more valuable."
...
If you replace "people" with "UIs", you basically have what the researchers discovered, the [aesthetic-usability effect](https://www.nngroup.com/articles/aesthetic-usability-effect/). It says that we have a "tendency to perceive attractive products as more usable" and expect that they'll "work better — even if they aren’t actually more effective or efficient."

## Rationalizing Pretty

It seems almost every UX designer has cited this aesthetic-usability effect at one point or another to justify a design decision that makes the design better-looking at the expense of usability or clarity. (including yours truly)

And you know what? They're almost always wrong.

Why? Because _a lot_ of UX designers just aren't that good at design.

I'm definitely not the only one saying this, here's Michal Malewicz in his [tell it like it is article](https://uxdesign.cc/ux-has-pretty-bad-ux-fd2702e5c22a):
...
I nodded so hard after reading that I nearly broke my neck.

It takes some skill to make a design pretty, but it takes a lot more skill to make that same design pretty and usable.

To be clear, I’ve worked with some very talented designers, but I’ve also worked with some that merely _thought_ they were very talented.

Despite this, job postings ask UX designers to do both UX & UI design when many aren't remotely qualified to do both.

Not that I believe we should only have specialists, quite the contrary, but I don't believe we should expect them to do something that they haven't shown they're capable of doing.

## A Dumb Dichotomy

Designers citing this principle in defense of their "pretty" designs like to come up with this dumb dichotomy:  
_either we make it pretty or we make it usable._
...
Facebook Messenger recently redesigned its mobile app. Even though they simplified their app significantly, one thing they noticeably added was labels to their bottom tab bars. Is it cleaner without labels? Certainly. But adding labels doesn't all of a sudden make it an ugly design.
...
We learned this stuff in the ’90s (remember [mystery meat navigation?](http://www.webpagesthatsuck.com/mysterymeatnavigation.html)), but we seem to keep making the same mistakes over and over.

Unlike art, there's only one correct interpretation of a design and it's your job as a designer to make that crystal clear.
